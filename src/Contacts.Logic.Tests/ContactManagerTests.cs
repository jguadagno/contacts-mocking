...
namespace Contacts.Logic.Tests
{
    public class ContactManagerTests
    {
        ...
        public void GetContact_WithAnInvalidId_ShouldReturnNull()
        {
            ...
            Mock.Arrange(() => mockContactRepository.GetContact(Arg.IsInRange(int.MinValue, 0, RangeKind.Inclusive)))
        ...
        public void GetContact_WithAValidId_ShouldReturnContact()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.GetContact(Arg.IsInRange(1, int.MaxValue, RangeKind.Inclusive))).Returns(
        ...
        public void GetContacts_ShouldReturnLists()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.GetContacts()
        ...
        public void GetContacts_WithNullLastName_ShouldThrowException()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.GetContacts(Arg.IsAny<string>(), null));
        ...
        public void GetContacts_WithValidParameters_ShouldReturnLists()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.GetContacts(Arg.IsAny<string>(), Arg.IsAny<string>())).Returns(
        ...
        public void SaveContact_WithANullContact_ShouldThrowException()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.SaveContact(null));
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void SaveContact_WithNullFirstName_ShouldThrowException()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.SaveContact(Arg.IsAny<Contact>()));
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void SaveContact_WithValidContact_ShouldReturnTrue()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() => mockContactRepository.SaveContact(Arg.IsAny<Contact>()))
                .Returns(() => contact);
        ...
        public void DeleteContact_WithInvalidContactId_ShouldReturnFalse()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                    mockContactRepository.DeleteContact(Arg.IsInRange(int.MinValue, 0, RangeKind.Inclusive)))
                .Returns(false);
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void DeleteContact_WithNullContact_ShouldReturnFalse()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.DeleteContact(Arg.IsAny<Contact>())).Returns(false);
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void DeleteContact_WithExistingContact_ShouldReturnTrue()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.DeleteContact(Arg.IsAny<Contact>())).Returns(true);
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void GetContactPhones_WithValidContactId_ShouldReturnAListOfPhones()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.GetContactPhones(Arg.IsAny<int>())).Returns(new List<Phone>());
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void GetContactPhone_WithValidContactIdAndPhoneId_ShouldReturnPhone()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                    mockContactRepository.GetContactPhone(Arg.IsAny<int>(), Arg.IsAny<int>()))
                .Returns(new Phone());
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void GetContactAddress_WithValidContactIdAndAddressId_ShouldReturnAddress()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                    mockContactRepository.GetContactAddress(Arg.IsAny<int>(), Arg.IsAny<int>()))
                .Returns(new Address());
            var contactManager = new ContactManager(mockContactRepository);
        ...
        public void GetContactAddresses_WithValidContactId_ShouldReturnAListOfAddresses()
        {
            ...
            var mockContactRepository = Mock.Create<IContactRepository>();
            Mock.Arrange(() =>
                mockContactRepository.GetContactAddresses(Arg.IsAny<int>())).Returns(new List<Address>());
            var contactManager = new ContactManager(mockContactRepository);
